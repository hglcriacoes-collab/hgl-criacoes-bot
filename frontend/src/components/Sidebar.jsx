    ...
    <div className="w-64 bg-[#0a0a0a] border-r border-gray-800 h-screen flex flex-col fixed left-0 top-0 overflow-y-auto">
      ...
      <div className="p-6 border-b border-gray-800">
        <Link to="/dashboard" className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-yellow-400 via-green-400 to-blue-500 flex items-center justify-center">
          ...
          <div key={item.path}>
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${
                isActive(item.path)
                  ? 'bg-gradient-to-r from-yellow-500/20 via-green-500/20 to-blue-500/20 text-white border border-yellow-500/30'
